...
The running notebook of concepts and techniques from this sprint lives in [LESSONS.md](LESSONS.md).
It's organized by sprint phase — each phase has an Objectives block plus subject-grouped notes that grow as work progresses.
